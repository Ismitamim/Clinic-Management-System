    ...
    public partial class UcAdminOperationCRUDE : UserControl
    {
        ...
        private void btnPatientSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Please enter a Admin name.");
                    return;
                }


                string query = "SELECT * FROM Admin WHERE Name LIKE '" + value + "%'";
        ...
        private void UcAdminOperationCRUDE_Load(object sender, EventArgs e)
        {
